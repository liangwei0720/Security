namespace Monitor.Manager.DormForm
{
	partial class DormAdminList
	{
		...
		private void InitializeComponent ( )
		{
			...
			this.tcDormAdminID = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.管理员联系方式 = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.tcDormName.Visible = false;
			// 
			// tcDormFlools
			// 
			this.tcDormFlools.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
			this.tcDormFlools.DataPropertyName = "AdminName";
			this.tcDormFlools.HeaderText = "管理员信息";
			this.tcDormFlools.Name = "tcDormFlools";
			this.tcDormFlools.ReadOnly = true;
			// 
			// tcDormAdminID
			// 
			this.tcDormAdminID.DataPropertyName = "DormAdmins";
			this.tcDormAdminID.HeaderText = "公寓管理员ID";
			this.tcDormAdminID.Name = "tcDormAdminID";
			this.tcDormAdminID.ReadOnly = true;
			this.tcDormAdminID.Visible = false;
			// 
			// 管理员联系方式
			// 
			this.管理员联系方式.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
			this.管理员联系方式.DataPropertyName = "Mobile";
			this.管理员联系方式.HeaderText = "管理员联系方式";
			this.管理员联系方式.Name = "管理员联系方式";
			this.管理员联系方式.ReadOnly = true;
			// 
			// 卡号
			// 
			this.卡号.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
			this.卡号.DataPropertyName = "CardNumber";
			this.卡号.HeaderText = "卡号";
			this.卡号.Name = "卡号";
			this.卡号.Resizable = System.Windows.Forms.DataGridViewTriState.False;
			// 
			// tcDormID
			// 
			...
			this.Name = "DormAdminList";
			this.Text = "公寓列表";
			this.Load += new System.EventHandler(this.DormAdminList_Load);
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn tcDormAdminID;
		private System.Windows.Forms.DataGridViewTextBoxColumn 管理员联系方式;
